...
<div class="learn-press-subtab-content">
	...
	<?php if ( $query['items'] ) { ?>
        <table class="lp-list-table profile-list-courses profile-list-table">
            <thead>
            <tr>
                <th class="column-course"><?php _e( 'Khóa học', 'eduma' ); ?></th>
                <th class="column-date"><?php _e( 'Ngày', 'eduma' ); ?></th>
                <th class="column-passing-grade"><?php _e( 'Điểm đã đạt', 'eduma' ); ?></th>
                <th class="column-status"><?php _e( 'Tiến độ', 'eduma' ); ?></th>
            </tr>
            </thead>
            <tbody>
	...
	<?php } else {
		learn_press_display_message( __( 'Không có khóa học nào!', 'eduma' ) );
	} ?>
</div>
