...
<div class="course-results-progress">
	...
	<div class="course-progress">
		<?php if ( false !== ( $heading = apply_filters( 'learn-press/course/result-heading', __( 'Tiến độ học', 'eduma' ) ) ) ) { ?>
		...
		<div class="learn-press-progress lp-course-progress <?php echo $course_data->is_passed() ? ' passed' : ''; ?>"
			...
			<div class="lp-passing-conditional"
				 data-content="<?php printf( esc_html__( 'Điều kiện tốt nghiệp: %s%%', 'learnpress' ), $passing_condition ); ?>"
