...
<?php if ( $has_courses ) : ?>
	...
	<h3 class="box-title"><?php esc_html_e( 'Khóa học yêu thích', 'eduma' ); ?></h3>
...
<?php else: ?>
	...
	<?php learn_press_display_message( apply_filters( 'learn_press_wishlist_empty_course', esc_html__( 'Không có dữ liệu.', 'eduma' ) ), 'notice' ); ?>
