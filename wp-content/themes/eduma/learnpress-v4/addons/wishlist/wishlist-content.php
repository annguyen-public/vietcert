...
<div class="course-item">
	<div class="course-thumbnail">
		...
		<?php echo '<a class="course-readmore" href="' . esc_url( get_the_permalink() ) . '">' . esc_html__( 'Tìm hiểu thêm', 'eduma' ) . '</a>'; ?>
	</div>
		...
		<div class="course-meta">
			...
			<div class="course-price">
				<?php if ( $course->is_free() ) : ?>
					<div class="value free-course" itemprop="price" content="<?php esc_attr_e( 'Miễn phí', 'eduma' ); ?>">
