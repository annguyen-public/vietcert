...
function learn_press_get_subtabs_course() {
	$subtabs = array(
		'all'       => __( 'Tất cả', 'learnpress' ),
		'learning'  => __( 'Đang học', 'learnpress' ),
		'purchased' => __( 'Đã mua', 'learnpress' ),
		'finished'  => __( 'Đã hoàn thành', 'learnpress' ),
		'own'       => __( 'Đã đăng', 'learnpress' ),
	);
...
function learn_press_get_students_list_filter() {
	$filter = array(
		'all'         => esc_html__( 'Tất cả', 'learnpress' ),
		'in-progress' => esc_html__( 'Đang học', 'learnpress' ),
		'finished'    => esc_html__( 'Đã kết thúc', 'learnpress' ),
	);
