...
class LP_Template_Profile extends LP_Abstract_Template {
	...
	public static function tab_courses() {
		...
		$courses_enrolled_tab = apply_filters(
			...
			array(
				''            => esc_html__( 'Tất cả', 'learnpress' ),
				'in-progress' => esc_html__( 'Đang học', 'learnpress' ),
				'finished'    => esc_html__( 'Đã kết thúc', 'learnpress' ),
				'passed'      => esc_html__( 'Đậu', 'learnpress' ),
				'failed'      => esc_html__( 'Rớt', 'learnpress' ),
			)
		);
		...
		$courses_created_tab = apply_filters(
			...
			array(
				''        => esc_html__( 'Tất cả', 'learnpress' ),
				'publish' => esc_html__( 'Đã đăng', 'learnpress' ),
				'pending' => esc_html__( 'Đang chờ', 'learnpress' ),
			)
		);
