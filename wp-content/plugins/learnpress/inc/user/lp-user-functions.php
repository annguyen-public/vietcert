...
function lp_add_default_fields( $fields ) {
	...
	if ( $first_name === 'yes' ) {
		?>
		<li class="form-field">
			<label for="reg_first_name"><?php esc_html_e( 'Họ và tên đệm', 'learnpress' ); ?></label>
			<input id="reg_first_name" name="reg_first_name" type="text"
				   placeholder="<?php esc_attr_e( 'Họ và tên đệm', 'learnpress' ); ?>"
	...
	if ( $last_name === 'yes' ) {
		?>
		<li class="form-field">
			<label for="reg_last_name"><?php esc_html_e( 'Tên', 'learnpress' ); ?></label>
			<input id="reg_last_name" name="reg_last_name" type="text"
				   placeholder="<?php esc_attr_e( 'Tên', 'learnpress' ); ?>"
	...
	if ( $display_name === 'yes' ) {
		?>
		<li class="form-field">
			<label for="reg_display_name"><?php esc_html_e( 'Tên hiển thị', 'learnpress' ); ?></label>
			<input id="reg_display_name" name="reg_display_name" type="text"
				   placeholder="<?php esc_attr_e( 'Tên hiển thị', 'learnpress' ); ?>"
...
function learn_press_social_profile_name( $key ) {
	...
	switch ( $key ) {
		case 'facebook':
			$name = esc_html__( 'Trang facebook cá nhân', 'learnpress' );
			break;
		case 'twitter':
			$name = esc_html__( 'Trang twitter cá nhân', 'learnpress' );
			break;
		case 'googleplus':
			$name = esc_html__( 'Trang Google cá nhân', 'learnpress' );
			break;
		case 'youtube':
			$name = esc_html__( 'Kênh youtube cá nhân', 'learnpress' );
			break;
		case 'linkedin':
			$name = esc_html__( 'Trang linkedin cá nhân', 'learnpress' );
			break;
		default:
			$name = ucfirst( $key );
	}
