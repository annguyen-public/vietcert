...
<div class="course-curriculum" id="learn-press-course-curriculum">
	<div class="curriculum-scrollable">
		...
		<?php else : ?>
			<?php
			echo wp_kses_post( apply_filters( 'learnpress/course/curriculum/empty', esc_html__( 'Chưa có chương trình giảng dạy', 'learnpress' ) ) );
			?>
		<?php endif; ?>
	</div>
	...
	<?php if ( $sections['pages'] > 1 && $sections['pages'] > $filters->page ) : ?>
		<div class="curriculum-more">
			<button class="curriculum-more__button" data-page="<?php echo esc_attr( $filters->page ); ?>">
				<?php esc_html_e( 'Hiển thị thêm nội dung', 'learnpress' ); ?>
			</button>
		</div>
	<?php endif; ?>
</div>
