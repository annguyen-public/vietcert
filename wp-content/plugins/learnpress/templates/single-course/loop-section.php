...
<li <?php $section->main_class(); ?>
	...
	<div class="section-header">
		<div class="section-left">
			<h5 class="section-title">
				...
				echo ! $title ? _x( 'Không có tiêu đề', 'template title empty', 'learnpress' ) : $title;
				?>
		...
		<?php if ( $user->has_enrolled_or_finished( $section->get_course_id() ) ) : ?>
			...
			<div class="section-meta">
				<div class="learn-press-progress" title="<?php echo esc_attr( sprintf( __( 'Tiến độ %s%%', 'learnpress' ), round( $percent, 2 ) ) ); ?>">
	...
	<?php if ( ! $items ) : ?>
		<?php learn_press_display_message( __( 'Không có bài học nào trong phần này', 'learnpress' ) ); ?>
	<?php else : ?>
