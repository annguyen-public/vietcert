...
<div class="learn-press-checkout-comment">
	<h4><?php esc_html_e( 'Ghi chú', 'learnpress' ); ?></h4>
	<textarea name="order_comments" class="order-comments" placeholder="<?php esc_attr_e( 'Gửi ghi chú tới quản trị viên', 'learnpress' ); ?>"></textarea>
</div>
