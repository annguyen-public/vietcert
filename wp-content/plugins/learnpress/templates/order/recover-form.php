...
<div class="order-recover">
	<input type="text" name="order-key" value="<?php echo esc_attr( $order_key ); ?>" placeholder="<?php esc_attr_e( 'Mã đặt hàng', 'learnpress' ); ?>">
	...
	<button type="button" class="lp-button button-recover-order"><?php esc_html_e( 'Khôi phục', 'learnpress' ); ?></button>
</div>
