...
if ( ! isset( $order ) ) {
	echo esc_html__( 'Đơn đặt hàng không hợp lệ', 'learnpress' );
	return;
}
?>

<h3><?php esc_html_e( 'Chi tiết đơn hàng', 'learnpress' ); ?></h3>

<table class="lp-list-table order-table-details">
	<thead>
		<tr>
			<th class="course-name"><?php esc_html_e( 'Khóa học', 'learnpress' ); ?></th>
			<th class="course-total"><?php esc_html_e( 'Tổng', 'learnpress' ); ?></th>
		</tr>
	</thead>
	...
	<tfoot>
		<tr>
			<th scope="row"><?php esc_html_e( 'Tạm tính', 'learnpress' ); ?></th>
			<td><?php echo $order->get_formatted_order_subtotal(); ?></td>
		</tr>
		<tr>
			<th scope="row"><?php esc_html_e( 'Tổng', 'learnpress' ); ?></th>
...
<p>
	<strong><?php echo esc_html__( 'Mã đặt hàng:', 'learnpress' ); ?></strong>
	<?php echo $order->get_order_key(); ?>
</p>

<p>
	<strong><?php esc_html_e( 'Trạng thái đặt hàng:', 'learnpress' ); ?></strong>
