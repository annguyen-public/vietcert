...
<div class="learn-press-subtab-content">
	...
	<?php if ( $query['items'] ) : ?>
		<table class="lp-list-table profile-list-quizzes profile-list-table">
			<thead>
				<tr>
					<th class="column-quiz"><?php esc_html_e( 'Bài tập', 'learnpress' ); ?></th>
					<th class="column-status"><?php esc_html_e( 'Kết quả', 'learnpress' ); ?></th>
					<th class="column-time-interval"><?php esc_html_e( 'Thời gian làm', 'learnpress' ); ?></th>
					<th class="column-date"><?php esc_html_e( 'Ngày', 'learnpress' ); ?></th>
				</tr>
			</thead>
	...
	<?php else : ?>
		<?php learn_press_display_message( esc_html__( 'Chưa có bài tập!', 'learnpress' ) ); ?>
	<?php endif; ?>
</div>
