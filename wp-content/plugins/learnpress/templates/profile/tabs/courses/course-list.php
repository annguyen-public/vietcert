...
<div class="lp_profile_course_progress">
	<div class="lp_profile_course_progress__item lp_profile_course_progress__header">
		<div></div>
		<div><?php esc_html_e( 'Tên', 'learnpress' ); ?></div>
		<div><?php esc_html_e( 'Kết quả', 'learnpress' ); ?></div>
		<div><?php esc_html_e( 'Thời hạn', 'learnpress' ); ?></div>
		<div><?php esc_html_e( 'Kết thúc', 'learnpress' ); ?></div>
	</div>
	<?php endif; ?>
...
<?php if ( $num_pages > 1 && $current_page < $num_pages && $current_page === 1 ) : ?>
	<div class="lp_profile_course_progress__nav">
		<button data-paged="<?php echo absint( $current_page + 1 ); ?>"
				data-number="<?php echo absint( $num_pages ); ?>"><?php esc_html_e( 'Tìm hiểu thêm', 'learnpress' ); ?></button>
	</div>
<?php endif; ?>
