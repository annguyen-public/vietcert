	...
	<div class="section-header">
		<div class="section-left">
			<h3 class="section-title">
				<?php echo ! empty( $section['section_name'] ) ? esc_html( $section['section_name'] ) : _x( 'Không có tiêu đề', 'template title empty', 'learnpress' ); ?>
	...
	<div class="section-item" data-section-id="<?php echo esc_attr( $section['section_id'] ); ?>">
		...
		<?php if ( ! empty( $object_data->pages ) && $object_data->pages > 1 ) : ?>
			<div class="section-item__loadmore" data-page="1">
				<button><?php esc_html_e( 'Xem thêm', 'learnpress' ); ?></button>
			</div>
		<?php endif; ?>
	</div>
</li>
