...
<button class="write-a-review"><?php _e( 'Viết đánh giá', 'learnpress-course-review' ); ?></button>
<div class="course-review-wrapper" id="course-review">
    ...
    <div class="review-form" id="review-form">
        ...
        <form>
            <h3>
				<?php _e( 'Viết đánh giá', 'learnpress-course-review' ); ?>
                <a href="" class="close dashicons dashicons-no-alt"></a>
            </h3>
            <ul class="review-fields">
				<?php do_action( 'learn_press_before_review_fields' ); ?>
                <li>
                    <label><?php _e( 'Tiêu đề', 'learnpress-course-review' ); ?> <span class="required">*</span></label>
                    <input type="text" name="review_title"/>
                </li>
                <li>
                    <label><?php _e( 'Nội dung', 'learnpress-course-review' ); ?><span class="required">*</span></label>
                    <textarea name="review_content"></textarea>
                </li>
                <li>
                    <label><?php _e( 'Đánh giá', 'learnpress-course-review' ); ?><span class="required">*</span></label>
                ...
                <li class="review-actions">
                    <button type="button" class="submit-review"
                            data-id="<?php the_ID(); ?>"><?php _e( 'Thêm đánh giá', 'learnpress-course-review' ); ?></button>
                    <span class="ajaxload"></span>
                    <button type="button" class="close"><?php _e( 'Hủy', 'learnpress-course-review' ); ?></button>
