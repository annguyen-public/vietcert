...
if ( $course_review['total'] ) {
    ...
    <div id="course-reviews-shortcode">
        <h3 class="course-review-head"><?php _e( 'Đánh giá', 'learnpress-course-review' ); ?></h3>
        <p class="course-average-rate"><?php printf( __( 'Điểm đánh giá trung bình: <span>%.1f</span>', 'learnpress-course-review' ), $course_rate ); ?></p>
	...
	_e( 'Chưa có đánh giá nào', 'learnpress-course-review' );
}